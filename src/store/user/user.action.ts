...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: User, additionalData: AdditionalInformation }>
...
export const signUpSuccess = withMatcher((user: User, additionalData: AdditionalInformation): SignUpSuccess =>
